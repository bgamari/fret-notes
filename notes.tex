...
Fluorescence lifetimes provide an estimate for the FRET efficiency unaffected by
$\gamma$. If $\gamma$ itself is needed, it can be easily derived from
the FRET efficiency computed from the lifetime in conjunction with the
observed proximity ratio.
