...
\item[$E$] FRET efficiency not corrected for $\gamma$
\item[$\phi_{A}$] Quantum yield of acceptor dye
\item[$\eta_{AD}$] Probability of detection of acceptor photon by donor detector
\item[$\eta_A = \eta_{AA}$] Probability of detection of acceptor photon by acceptor detector
