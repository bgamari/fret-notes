...
artifact is largely due to the imperfect nature the dichroic mirrors
used to separate donor and acceptor fluorescence and nearly always
results in leakage of a constant fraction of donor photons into the
acceptor channel.

Finally, all experiments must deal with a constant-rate
background on top of the measured signal. Sources of this background
...
Accounting for these effects yields an result for the intensity
