...
artifact is largely due to the imperfect nature
the dichroic mirrors used to separate donor and acceptor fluorescence and nearly always results in leakage of donor photons into the
acceptor channel. Moreover, all experiments must deal with a constant-rate
background on top of the measured signal. Accounting for these two effects
yields an result for the intensity observed by the detectors,
\begin{align*}
