...
excitations which produce a photon the quantum yield $\phi$,
\begin{align*}
...
$k_{exc}$ to find fluorescence emission rates $n_D$ and $n_A$,
\begin{align}
...
\item[$I_A$] Observed photon count rate from acceptor fluorophore with contributions from background and crosstalk
